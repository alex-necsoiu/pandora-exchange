...
- Follow the folder structure, naming conventions, coding patterns, and security rules described in the Architecture Doc (Go 1.21+, Gin, sqlc, gRPC, Redis Streams, OTEL, Argon2id, go-jwt, Vault, Docker, Kubernetes, sqlc-first DB patterns, no domain logic in transport layers, DI in cmd, etc.)
